...
export class EnquiryServiceService {
  ...
  update_enquiry(id, data) {
    return this.http.put(this.newurl + "/update_enquiry/" + id, data, { headers: this.headers })
  }
  ...
  delete_comment(id) {
    return this.http.delete(this.comment_url + "/" + id, { headers: this.headers })
  }
  ...
  update_status(id, data) {
    return this.http.put(this.status_url + "/" + id, data, { headers: this.headers })
  }
  ...
  get_all_drop_enquiry(data) {
    return this.http.post(this.newurl + "/get_team_wise_drop",data, { headers: this.headers })
  }
  // lead=====================================
  get_today_add_lead() {
  ...
  get_team_wise_task(data){
    return this.http.post(this.check1 + "/get_team_task/" , data ,{ headers: this.headers })
  }
  ...
  /////reportenquiry =======================
  get_date_wise(data) {
    return this.http.post(this.newurl + "/Enquiry/only_date_wise", data, { headers: this.headers })
  }
  get_date_and_wise(data) {
    return this.http.post(this.newurl + "/Enquiry/date_and_enquiry", data, { headers: this.headers })
  }
  // enquiry_ filetr - =================================
  get_mobile_wise(data) {
    return this.http.post(this.newurl + "/get_mobile_nomber", data, { headers: this.headers })
  }
  get_enq_type(data) {
    return this.http.post(this.newurl + "/get_enq_type", data, { headers: this.headers })
  }
  get_cust_type(data) {
    return this.http.post(this.newurl + "/get_cust_type", data, { headers: this.headers })
  }
  get_sorce_wise(data) {
    return this.http.post(this.newurl + "/get_sorce", data, { headers: this.headers })
  }
  get_state_wise(data) {
    return this.http.post(this.newurl + "/get_state", data, { headers: this.headers })
  }
  get_city_wise(data) {
    return this.http.post(this.newurl + "/get_city", data, { headers: this.headers })
  }
  get_role_besd_active_enq(){
    return this.http.get(this.newurl + "/get_all_user_role/" ,{ headers: this.headers })
  }

  // team wise enquiry ,lead, calient and task =================
  get_team_wise_enquiry(data) {
    return this.http.post(this.newurl + "/get_team_wise_enquiry/", data, { headers: this.headers })
  }
  get_team_wise_activ_enquiry(data) {
    return this.http.post(this.newurl + "/get_team_wise_active_enq/", data, { headers: this.headers })
  }
  get_team_wise_lead(data) {
    return this.http.post(this.newurl + "/get_team_wise_lead/", data, { headers: this.headers })
  }
  get_team_wise_client(data){
    return this.http.post(this.newurl + "/get_team_wise_client/" ,data,{ headers: this.headers })
  }
}
