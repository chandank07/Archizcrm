...
export const horizontalMenuItems = [ 
    new Menu (1, 'Dashboard', '/dashboard', null, 'dashboard', null, false, 0),
    new Menu (2, 'Users', '/users', null, 'supervisor_account', null, false, 0), 
    new Menu (3, 'Lead Management', null, null, 'dns', null, true, 0),
    // new Menu (4, 'enquiry', '/enquiry/enquiry', null, 'computer', null, false, 3), 
    new Menu (4, 'enquiry', '/Lead/enquiry/', null, 'contact_support', null, false, 3),
    new Menu (5, 'Client', '/change', null, 'perm_identity', null, false, 3), 
    new Menu (6, 'Lead', '/enquiry12', null, 'swap_horiz', null, false, 3), 
    new Menu (7, 'Task', '/ui/buttons', null, 'list_alt', null, false, 3), 
    // new Menu (3, 'UI Features', null, null, 'computer', null, true, 0),   
    // new Menu (4, 'Buttons', '/ui/buttons', null, 'keyboard', null, false, 3),  
    // new Menu (5, 'Cards', '/ui/cards', null, 'card_membership', null, false, 3), 
    // new Menu (6, 'Lists', '/ui/lists', null, 'list', null, false, 3), 
