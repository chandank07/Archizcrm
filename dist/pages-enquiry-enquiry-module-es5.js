...
var EnquiryDilogComponent = /** @class */ (function () {
    function EnquiryDilogComponent(dialogRef, router, user, snackBar, fb, enquiryService) {
    ...
    EnquiryDilogComponent.prototype.ngOnInit = function () {
        var _this = this;
        console.log(this.user);
        if (!this.user) {
            this.enquiryService.get_enquiry_form().subscribe(function (res) {
                _this.enquiry_field = res.data[0].received;
                _this.setFormValue(_this.enquiry_field);
            });
        }
        else {
    ...
    EnquiryDilogComponent.prototype.get_enquiry_form = function () {
        var _this = this;
        var data = this.orderForm.value;
        console.log(data);
        this.enquiryService.get_enquiry_form().subscribe(function (res) {
            _this.enquiry_field = res.data;
            console.log(_this.enquiry_field);
            if (_this.enquiry_field.length > 0) {
                console.log("djsfghdsgfh");
                _this.enquiryService.update_enquiry_form(data).subscribe(function (res) {
                    console.log(res);
                });
            }
            else {
                _this.enquiryService.create_enquiry_form(data).subscribe(function (res) {
                    console.log(res);
                });
            }
        });
    };
    EnquiryDilogComponent.prototype.createItem = function () {
    ...
    Object.defineProperty(EnquiryDilogComponent.prototype, "formarr", {
        // get formArr() {
    ...
    EnquiryDilogComponent.prototype.addItem = function () {
        this.formarr.push(this.createItem());
    };
    EnquiryDilogComponent.prototype.removePeriod = function (i) {
        this.formarr.removeAt(i);
    };
    EnquiryDilogComponent.prototype.get_source = function () {
        var _this = this;
        this.enquiryService.Enquiry_sourc().subscribe(function (res) {
            _this.source = res.source;
            console.log(_this.source);
        });
    };
    EnquiryDilogComponent.prototype.changeuserRole = function () {
        var user_role = this.form.get('source').value;
        console.log(user_role);
    };
    EnquiryDilogComponent.prototype.close = function () {
        this.dialogRef.close();
    };
    EnquiryDilogComponent.prototype.submit = function () {
        var _this = this;
        ...
        console.log(data);
        this.enquiryService.create_enquiry(data).subscribe(function (res) {
            _this.users = res.data;
            if (res.status == 200 && res.error == false) {
                _this.dialogRef.close(_this.orderForm.value);
                var message = "Enquiry Create Successfully.";
                var action = "OK";
    ...
    EnquiryDilogComponent.prototype.add_form = function () {
        console.log("dkjdjgh");
    ...
    EnquiryDilogComponent.prototype.setFormValue = function (data) {
    ...
    EnquiryDilogComponent.prototype.create_form = function () {
...
var EnquiryComponent = /** @class */ (function () {
    function EnquiryComponent(appSettings, dialog, enquiryService) {
    ...
    EnquiryComponent.prototype.ngOnInit = function () {
        var _this = this;
        // this.get_source()
        this.enquiryService.get_enquiry().subscribe(function (res) {
            _this.users = res.data;
            // this.enquiry_field = res.data;
        });
        this.enquiryService.me().subscribe(function (data) {
            console.log(data);
        });
    };
    EnquiryComponent.prototype.openUserDialog = function (user) {
        var _this = this;
        var dialogRef = this.dialog.open(_enquiry_dilog_enquiry_dilog_component__WEBPACK_IMPORTED_MODULE_4__["EnquiryDilogComponent"], {
            data: user
        });
    ...
    EnquiryComponent.prototype.onPageChanged = function (event) {
        this.page = event;
        this.ngOnInit();
...
var EnquiryServiceService = /** @class */ (function () {
    function EnquiryServiceService(http) {
        this.http = http;
    ...
    EnquiryServiceService.prototype.Create_enquiry = function (userdata) {
        return this.http.post(this.url + '/create', userdata);
    };
    EnquiryServiceService.prototype.Enquiry_sourc = function () {
        return this.http.post(this.url + '/source', { headers: this.headers });
    };
    EnquiryServiceService.prototype.create_enquiry_form = function (data) {
        console.log(this.headers);
        return this.http.post(this.url2 + "/enquiryForm/create", data, { headers: this.headers });
    };
    EnquiryServiceService.prototype.create_enquiry = function (data) {
        console.log(this.headers);
        return this.http.post(this.url2 + "/enquiry/create", data, { headers: this.headers });
    };
    EnquiryServiceService.prototype.update_enquiry_form = function (data) {
        console.log(this.headers);
    ...
    // }
    EnquiryServiceService.prototype.get_enquiry_form = function () {
        return this.http.get(this.url2 + "/enquiryForm", { headers: this.headers });
    };
    EnquiryServiceService.prototype.get_enquiry = function () {
        return this.http.get(this.url2 + "/enquiry", { headers: this.headers });
    };
    EnquiryServiceService.prototype.me = function () {
...
//# sourceMappingURL=pages-enquiry-enquiry-module-es5.js.map