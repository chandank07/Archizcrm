...
var routes = [
    { path: '', redirectTo: 'login', pathMatch: 'full' },
    {
        ...
        component: _pages_pages_component__WEBPACK_IMPORTED_MODULE_1__["PagesComponent"], children: [
            { path: 'dashboard', loadChildren: function () { return __webpack_require__.e(/*! import() | pages-dashboard-dashboard-module */ "pages-dashboard-dashboard-module").then(__webpack_require__.bind(null, /*! ./pages/dashboard/dashboard.module */ "./src/app/pages/dashboard/dashboard.module.ts")).then(function (m) { return m.DashboardModule; }); }, data: { breadcrumb: 'Dashboard' } },
            { path: 'users', loadChildren: function () { return Promise.all(/*! import() | pages-users-users-module */[__webpack_require__.e("default~pages-enquiry-enquiry-module~pages-users-users-module"), __webpack_require__.e("pages-users-users-module")]).then(__webpack_require__.bind(null, /*! ./pages/users/users.module */ "./src/app/pages/users/users.module.ts")).then(function (m) { return m.UsersModule; }); }, data: { breadcrumb: 'Users' } },
            { path: 'Lead', loadChildren: function () { return Promise.all(/*! import() | pages-enquiry-enquiry-module */[__webpack_require__.e("default~pages-enquiry-enquiry-module~pages-users-users-module"), __webpack_require__.e("pages-enquiry-enquiry-module")]).then(__webpack_require__.bind(null, /*! ./pages/enquiry/enquiry.module */ "./src/app/pages/enquiry/enquiry.module.ts")).then(function (m) { return m.EnquiryModule; }); }, data: { breadcrumb: 'Enquiry' } },
            ...
            { path: 'dynamic-menu', loadChildren: function () { return __webpack_require__.e(/*! import() | pages-dynamic-menu-dynamic-menu-module */ "pages-dynamic-menu-dynamic-menu-module").then(__webpack_require__.bind(null, /*! ./pages/dynamic-menu/dynamic-menu.module */ "./src/app/pages/dynamic-menu/dynamic-menu.module.ts")).then(function (m) { return m.DynamicMenuModule; }); }, data: { breadcrumb: 'Dynamic Menu' } },
